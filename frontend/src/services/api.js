...
export async function apiRequest(base, path, body, { signal } = {}) {
  ...
  if (['/upload','/generate','/furnish','/edit-object','/delete-object','/add-object','/recolor-object'].includes(path)) imageSource(data.image, data.mime_type);
  return data;
}
export async function furnishRequest(base, body, { signal } = {}) {
  return apiRequest(
    base,
    '/furnish',
    body,
